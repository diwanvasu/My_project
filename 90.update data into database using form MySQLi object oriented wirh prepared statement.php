...
if ($_SERVER['REQUEST_METHOD']=="POST") {
    ...
    if (isset($_REQUEST['update'])) {
        ...
        if (($_REQUEST['name']=="") || ($_REQUEST['roll']=="") || ($_REQUEST['address']=="") ) 
        {
            ...
            if($result->execute()){
                echo $result->affected_rows."Record has been upadated successfully";
            }else{
                echo"Record are not update successfully";
            }
            $result->close(); 
        }
...
<form action="" method="POST">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="roll" name="roll" value="<?php if(isset($roll)){echo $roll;}?>">
  </div>
  <div class="mb-3">
...
<table class="table">
  ...
  $sql="SELECT *FROM student";
    ...
    echo'<tr>
      ...
      <input type="submit" name="delete" id="delete" class="btn btn-danger" value="Delete"/> <input type="submit" name="edit" id="edit" class="btn btn-info" value="Edit"></form><td>
    </tr>';
    }$result->close();
